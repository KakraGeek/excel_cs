/**
 * Primary School Gallery Page Component
 * 
 * This page displays the Primary School gallery with photos of school activities.
...
export default async function PrimarySchoolGalleryPage() {
  // Fetch images for the primary school gallery
  const images = await db.imageAsset.findMany({
    where: { galleryId: 'gallery-primary-school' },
    orderBy: { order: 'asc' },
  });
  return (
    <div className="flex flex-col">
      <ParallaxHero 
        ...
        subtitle="Memorable Moments from Our Primary School Activities"
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                ...
                experiences in our Primary School programme.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold">
              See Our Primary School in Action
            </h2>
            <p className="text-lg md:text-xl text-blue-100">
              Book an appointment to visit our Primary School and see our learning environment firsthand.
            </p>
            {/* Admissions CTA */}
            <div className="pt-4">
              <CTAButton
